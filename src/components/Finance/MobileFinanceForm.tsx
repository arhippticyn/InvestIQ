...
import styles from '../../sass/components/Expense/MobileForm.module.scss'
...
const MobileFinanceForm = ({ type }: FinanceFormProps) => {
    ...
    return (
        <section className={styles.mobileForm}>
            <div className={styles.mobileContainer}>
                <button type='button' className={`${styles.openModal} ${isOpen ? styles.opened : ''}`} onClick={() => setIsOpen(prev => !prev)}>
                    <HiPlus size={24} />
                </button>
...
export default MobileFinanceForm